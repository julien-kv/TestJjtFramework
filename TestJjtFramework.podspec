...
If you are using Swift, we recommend our **[Swift Library](https://github.com/mixpanel/mixpanel-swift)**.
 ...
 DESC
  ...
  spec.homepage     = "https://github.com/julien-kv/TestJjtFramework"
  spec.screenshots  = "https://picsum.photos/200/300", "https://picsum.photos/seed/picsum/200/300"
  ...
  # Or just: spec.author    = "julienKeyvalue"
  # spec.authors            = { "julienKeyvalue" => "julien@keyvalue.systems" }
  spec.social_media_url   = "https://twitter.com/IamSanjuSamson"
  ...
  spec.source       = { :git => "https://github.com/julien-kv/TestJjtFramework.git", :tag => "#{spec.version}" }
  ...
  #
  spec.vendored_frameworks  = "TestJjtFramework.xcframework"
  spec.readme = "https://github.com/RichardLitt/standard-readme/blob/main/spec.md"
